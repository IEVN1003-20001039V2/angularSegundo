...
export class ZodiacoComponent {
  ...
  imprimir() {
    ...
    const signoZodiacal = this.obtenerSignoZodiacal(formValues.dia, formValues.mes);
  ...
  obtenerSignoZodiacal(dia: number, mes: number): string {
    // Implementa la lógica para calcular el signo zodiacal según el día y mes
    return 'Acuario'; // ejemplo
  }
  ...
  obtenerImagenSigno(signoChino: string): string {
    const signosImagenes: { [key: string]: string } = {
      ...
      'Bufalo': 'https://th.bing.com/th/id/OIP.4yCh1NPLgWdGiuDko1GQBgHaHa?rs=1&pid=ImgDetMain',
      'Dragon': 'https://th.bing.com/th/id/OIP.zImplN-9yZyu9aS7FBdViAAAAA?rs=1&pid=ImgDetMain',
      'Serpinte': 'https://media.istockphoto.com/id/165928604/es/vector/año-de-la-serpiente.jpg?s=612x612&w=0&k=20&c=PzUCeE7bPjjZAJZNZ1ovmvBdjJsPz_15OhLKH6q9NCM=',
      ...
      'Conojeo': 'https://img.freepik.com/vector-premium/ilustracion-ano-lunar-conejo-zodiaco-chino-ano-conejo_692702-8585.jpg?w=740',

      // Añadir más signos e imágenes
    };
